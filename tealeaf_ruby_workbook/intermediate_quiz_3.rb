...
#My string looks like this now: pumpkins       --new string
#My array looks like this now: ["pumpkins", "rutabaga"]       ---appended array
...
#My string looks like this now: rutabaga  ---new string
#My array looks like this now: ["pumpkins"]   ---new array
